...
class ReplicateClient:
    ...
    def generate_image(
        ...
        logger.debug(f"CRITICAL DEBUG - Received params: {json.dumps(params, indent=2)}")
        logger.debug(f"CRITICAL DEBUG - Constructed payload: {json.dumps(payload, indent=2)}")
        ...
        intended_payload["api_filtering_detected"] = self._detect_filtering(payload, actual_payload)
    ...
    def _call_with_retry(
        ...
        for attempt in range(1, self.max_retries + 1):
            try:
                ...
                logger.debug(f"CRITICAL DEBUG - Payload sent to replicate.run: {json.dumps(payload, indent=2)}")
    ...
    def _detect_filtering(self, intended: Dict[str, Any], actual: Dict[str, Any]) -> bool:
        """
    ...
    def _get_filtered_parameters(self, intended: Dict[str, Any], actual: Dict[str, Any]) -> list:
        """
